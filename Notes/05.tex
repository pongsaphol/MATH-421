...
\begin{proof}
  ...
  \begin{enumerate}[1.]
    ...
    $$U(f, P_2) < \int_a^b + \frac{\eps}{10}$$
    Then we get 
    $$\int_a^b f - \frac{\eps}{10} < L(f, P_1) \leq L(f, P_1\cup P_2) \leq U(f, P_1\cup P_2) \leq U(f, P_2) < \int_a^b + \frac{\eps}{10}$$
...
$$\forall \eps > 0, \exists \delta > 0, |x-x_0| < \delta \implies |f(x) - f(x_0)| < \eps (x \in [a, b])$$
